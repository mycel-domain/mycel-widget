 ...
 *
 * @property {string} outputAmount - The estimation of Mycel from output amount of Y
 ...
 * @property {boolean} validResult - If false, Mycel was unable to fetch the balance of this address to check the
