 ...
 * @property {string} outputAmount - The estimation of Mycel from output amount for Y
 * @property {string} outputAmountMin - The estimation of Mycel from output amount for Y
 * @property {number | null} outputAmountUsd - The estimation of Mycel from output usd value for Y
